...
Lol.i18n['en-us'] =
  ...
  # Form Validate
  form_validate_required			: "This field can not be blank"
  form_validate_phone					: "Enter a valid phone number"
  form_validate_email					: "Enter a valid email address"
  form_validate_url						: "Enter a valid url"
  form_validate_alphaNumeric	: "This field should only contain text and numbers"
  form_validate_alpha					: "This field should only contain text"
  form_validate_integer				: "This field must contain numbers"
  form_validate_max			      : "This field exceeded the maximum allowed"
  form_validate_min     			: "This field does not have the minimum required"
  form_validate_maxlength			: "This field exceeded the maximum size"
  form_validate_minlength			: "This field has the minimum size"